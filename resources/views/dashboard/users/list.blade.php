        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                @if (Auth::guard('admin')->user()->role == 'admin')
                    <a href="{{ route('UserAdd') }}" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
                @endif
                <!--end::Actions-->
            </div>
            <!--end::Info-->
                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    @if (Auth::guard('admin')->user()->role == 'admin')
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('UserAdd') }}" class="btn btn-primary font-weight-bolder">
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown dropdown-inline mr-2">
                                                ...
                                                <button type="button"
                                                    ...
                                                    <i class="ki ki-bold-more-hor"></i></button>
                                                <!--begin::Dropdown Menu-->
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-left">
                                                    ...
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        ...
                                                        @if (Auth::guard('admin')->user()->role == 'admin')
                                                            <li class="navi-item">
                                                                <a onclick="remove('{{ route('UserDelete', Crypt::encrypt($user->id)) }}');"
                                                                    {{-- href="{{ route('UserDelete', Crypt::encrypt($user->id)) }}" --}} class="navi-link">
                                                                    <span class="navi-icon">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            xmlns:xlink="http://www.w3.org/1999/xlink"
